...
def openAOO():
    ...
    def set_params():
        with serial.Serial(port=port_name, baudrate=baudrate) as device:	
            params = [1,0,0,int(VentAmp*20),int(VentPW*(100/30)),int(VentSens*20),int(AtrAmp*20),int(AtrPW*(100/30)),int(AtrSens*20),Hyst,LowRL,AVDelay,VRP,ARP,HEI,MaxSR,0,ReacTime,RespF,RecTime]
