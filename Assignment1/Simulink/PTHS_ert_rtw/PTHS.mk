...
## 
## Makefile     : PTHS.mk
## Generated on : Thu Dec 03 22:53:25 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PTHS.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PTHS.elf
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o PTHS.o PTHS_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/PTHS_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PTHS_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PTHS_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PTHS_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/PTHS_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PTHS.o : $(START_DIR)/PTHS_ert_rtw/PTHS.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PTHS_data.o : $(START_DIR)/PTHS_ert_rtw/PTHS_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/PTHS_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/PTHS_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/PTHS_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
