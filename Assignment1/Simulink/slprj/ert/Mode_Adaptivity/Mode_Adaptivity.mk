###########################################################################
## Makefile generated for Simulink model 'Mode_Adaptivity'. 
## 
## Makefile     : Mode_Adaptivity.mk
## Generated on : Thu Dec 03 19:31:02 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: ./Mode_Adaptivity_rtwlib.lib
...
COMPILER_COMMAND_FILE     = Mode_Adaptivity_comp.rsp
CMD_FILE                  = Mode_Adaptivity.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = Mode_Adaptivity_rtwlib.lib
...
PRODUCT = ./Mode_Adaptivity_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=Mode_Adaptivity -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = i2c_api.o MW_I2C.o mw_sdk_interface.o Mode_Adaptivity.o
...
%.o : $(START_DIR)/slprj/ert/Mode_Adaptivity/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/Mode_Adaptivity/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/Mode_Adaptivity/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/Mode_Adaptivity/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/Mode_Adaptivity/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Mode_Adaptivity.o : $(START_DIR)/slprj/ert/Mode_Adaptivity/Mode_Adaptivity.c
	$(CC) $(CFLAGS) -o "$@" "$<"
