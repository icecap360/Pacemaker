###########################################################################
## Makefile generated for Simulink model 'Serial_Read'. 
## 
## Makefile     : Serial_Read.mk
## Generated on : Thu Dec 03 16:47:23 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: ./Serial_Read_rtwlib.lib
...
COMPILER_COMMAND_FILE     = Serial_Read_comp.rsp
CMD_FILE                  = Serial_Read.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = Serial_Read_rtwlib.lib
...
PRODUCT = ./Serial_Read_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=Serial_Read -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SCI.o MW_AnalogInput.o mw_sdk_interface.o Serial_Read.o
...
%.o : $(START_DIR)/slprj/ert/Serial_Read/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/Serial_Read/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/Serial_Read/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/Serial_Read/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/Serial_Read/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Serial_Read.o : $(START_DIR)/slprj/ert/Serial_Read/Serial_Read.c
	$(CC) $(CFLAGS) -o "$@" "$<"
