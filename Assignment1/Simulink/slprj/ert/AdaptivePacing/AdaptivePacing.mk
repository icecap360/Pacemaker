###########################################################################
## Makefile generated for Simulink model 'AdaptivePacing'. 
## 
## Makefile     : AdaptivePacing.mk
## Generated on : Thu Dec 03 15:03:08 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: ./AdaptivePacing_rtwlib.lib
...
COMPILER_COMMAND_FILE     = AdaptivePacing_comp.rsp
CMD_FILE                  = AdaptivePacing.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = AdaptivePacing_rtwlib.lib
...
PRODUCT = ./AdaptivePacing_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=AdaptivePacing -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o i2c_api.o MW_I2C.o AdaptivePacing.o
...
%.o : $(START_DIR)/slprj/ert/AdaptivePacing/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/AdaptivePacing/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/AdaptivePacing/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/AdaptivePacing/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/AdaptivePacing/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
AdaptivePacing.o : $(START_DIR)/slprj/ert/AdaptivePacing/AdaptivePacing.c
	$(CC) $(CFLAGS) -o "$@" "$<"
