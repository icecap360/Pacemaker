###########################################################################
## Makefile generated for Simulink model 'Assignment2_incase_unofficial'. 
## 
## Makefile     : Assignment2_incase_unofficial.mk
## Generated on : Thu Dec 03 15:18:31 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Assignment2_incase_unofficial.elf
...
PRODUCT_NAME              = Assignment2_incase_unofficial
MAKEFILE                  = Assignment2_incase_unofficial.mk
...
COMPILER_COMMAND_FILE     = Assignment2_incase_unofficial_comp.rsp
CMD_FILE                  = Assignment2_incase_unofficial.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Assignment2_incase_unofficial.elf
...
DEFINES_STANDARD = -DMODEL=Assignment2_incase_unofficial -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment2_incase_unofficial.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/Assignment2_incase_unofficial.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment2_incase_unofficial_data.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/Assignment2_incase_unofficial_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Assignment2_incase_unofficial_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
