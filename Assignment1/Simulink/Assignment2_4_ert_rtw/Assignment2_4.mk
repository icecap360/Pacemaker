...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Assignment2_4.elf
...
MODELREF_LINK_RSPFILE     = Assignment2_4_ref.rsp
COMPILER_COMMAND_FILE     = Assignment2_4_comp.rsp
CMD_FILE                  = Assignment2_4.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Assignment2_4.elf
...
DEFINES_STANDARD = -DMODEL=Assignment2_4 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SCI.o MW_AnalogInput.o mw_sdk_interface.o i2c_api.o MW_I2C.o Assignment2_4.o Assignment2_4_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Assignment2_4_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment2_4_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment2_4_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment2_4_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment2_4_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Assignment2_4_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment2_4.o : $(START_DIR)/Assignment2_4_ert_rtw/Assignment2_4.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment2_4_data.o : $(START_DIR)/Assignment2_4_ert_rtw/Assignment2_4_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
