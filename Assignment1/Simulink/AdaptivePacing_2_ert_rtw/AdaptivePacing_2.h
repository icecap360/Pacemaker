...
#ifndef RTW_HEADER_AdaptivePacing_2_h_
#define RTW_HEADER_AdaptivePacing_2_h_
#include <math.h>
#include <string.h>
#include <float.h>
#include <stddef.h>
#ifndef AdaptivePacing_2_COMMON_INCLUDES_
# define AdaptivePacing_2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "MW_I2C.h"
#endif                                 /* AdaptivePacing_2_COMMON_INCLUDES_ */

#include "AdaptivePacing_2_types.h"
...
typedef struct {
  real_T activitythreshold105;         /* '<S1>/activity threshold (~1.05)' */
...
typedef struct {
  ...
  uint32_T is_c3_AdaptivePacing_2;     /* '<S1>/Chart' */
  uint32_T temporalCounter_i1;         /* '<S1>/Chart' */
  uint8_T is_active_c3_AdaptivePacing_2;/* '<S1>/Chart' */
} DW_AdaptivePacing_2_T;

/* Parameters (default storage) */
struct P_AdaptivePacing_2_T_ {
  real_T FXOS87006AxesSensor_SampleTime;/* Expression: -1
                                         * Referenced by: '<S1>/FXOS8700 6-Axes Sensor'
                                         */
  real_T activitythreshold105_Threshold;/* Expression: 1.05
...
struct tag_RTM_AdaptivePacing_2_T {
...
extern P_AdaptivePacing_2_T AdaptivePacing_2_P;

/* Block signals (default storage) */
extern B_AdaptivePacing_2_T AdaptivePacing_2_B;

/* Block states (default storage) */
extern DW_AdaptivePacing_2_T AdaptivePacing_2_DW;

/* Model entry point functions */
extern void AdaptivePacing_2_initialize(void);
extern void AdaptivePacing_2_step(void);
extern void AdaptivePacing_2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_AdaptivePacing_2_T *const AdaptivePacing_2_M;
 ...
 *
 * '<Root>' : 'AdaptivePacing_2'
 * '<S1>'   : 'AdaptivePacing_2/Adaptive Pacing'
 * '<S2>'   : 'AdaptivePacing_2/Adaptive Pacing/Chart'
 * '<S3>'   : 'AdaptivePacing_2/Adaptive Pacing/movingAverageFilter'
 */
#endif                                 /* RTW_HEADER_AdaptivePacing_2_h_ */
