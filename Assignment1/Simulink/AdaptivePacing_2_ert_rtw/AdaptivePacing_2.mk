###########################################################################
## Makefile generated for Simulink model 'AdaptivePacing_2'. 
## 
## Makefile     : AdaptivePacing_2.mk
## Generated on : Thu Dec 03 10:57:04 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/AdaptivePacing_2.elf
...
COMPILER_COMMAND_FILE     = AdaptivePacing_2_comp.rsp
CMD_FILE                  = AdaptivePacing_2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/AdaptivePacing_2.elf
...
DEFINES_STANDARD = -DMODEL=AdaptivePacing_2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = i2c_api.o MW_I2C.o mw_sdk_interface.o AdaptivePacing_2.o AdaptivePacing_2_data.o AdaptivePacing_2_tgtconn.o rtGetInf.o rtGetNaN.o rt_nonfinite.o updown.o ext_work.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o k64f_rtiostream_interface.o k64f_rtiostream_commservice.o k64f_ext_svr.o k64f_rtiostream_utils.o tgtSvc_UARTInfo.o
...
%.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AdaptivePacing_2.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/AdaptivePacing_2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AdaptivePacing_2_data.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/AdaptivePacing_2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AdaptivePacing_2_tgtconn.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/AdaptivePacing_2_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/AdaptivePacing_2_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
