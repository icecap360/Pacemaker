###########################################################################
## Makefile generated for Simulink model 'Assignment2_3'. 
## 
## Makefile     : Assignment2_3.mk
## Generated on : Thu Dec 03 17:04:36 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Assignment2_3.elf
...
MODELREF_LINK_RSPFILE     = Assignment2_3_ref.rsp
COMPILER_COMMAND_FILE     = Assignment2_3_comp.rsp
CMD_FILE                  = Assignment2_3.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Assignment2_3.elf
...
DEFINES_STANDARD = -DMODEL=Assignment2_3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/Assignment2_3_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment2_3_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment2_3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment2_3_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment2_3_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Assignment2_3_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment2_3.o : $(START_DIR)/Assignment2_3_ert_rtw/Assignment2_3.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment2_3_data.o : $(START_DIR)/Assignment2_3_ert_rtw/Assignment2_3_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
