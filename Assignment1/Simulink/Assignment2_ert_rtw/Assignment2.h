...
struct tag_RTM_Assignment2_T {
  const char_T *errorStatus;
};

/* Block parameters (default storage) */
extern P_Assignment2_T Assignment2_P;

/* Block signals (default storage) */
extern B_Assignment2_T Assignment2_B;

/* Block states (default storage) */
extern DW_Assignment2_T Assignment2_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_Assignment2_T Assignment2_PrevZCX;

/* Model entry point functions */
extern void Assignment2_initialize(void);
extern void Assignment2_step(void);
extern void Assignment2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Assignment2_T *const Assignment2_M;
