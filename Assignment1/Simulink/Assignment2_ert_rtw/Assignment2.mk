###########################################################################
## Makefile generated for Simulink model 'Assignment2'. 
## 
## Makefile     : Assignment2.mk
## Generated on : Thu Dec 03 15:32:12 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Assignment2.elf
...
MODELREF_LINK_RSPFILE     = Assignment2_ref.rsp
COMPILER_COMMAND_FILE     = Assignment2_comp.rsp
CMD_FILE                  = Assignment2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Assignment2.elf
...
DEFINES_STANDARD = -DMODEL=Assignment2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_SCI.o MW_AnalogInput.o Assignment2.o Assignment2_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
MODELREF_LIBS = ../slprj/ert/PTHS/PTHS_rtwlib.lib
...
%.o : $(START_DIR)/Assignment2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Assignment2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment2.o : $(START_DIR)/Assignment2_ert_rtw/Assignment2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment2_data.o : $(START_DIR)/Assignment2_ert_rtw/Assignment2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
