...
#ifndef RTW_HEADER_AdaptivePacing_3_h_
#define RTW_HEADER_AdaptivePacing_3_h_
#include <math.h>
#include <string.h>
#include <float.h>
#include <stddef.h>
#ifndef AdaptivePacing_3_COMMON_INCLUDES_
# define AdaptivePacing_3_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "MW_I2C.h"
#endif                                 /* AdaptivePacing_3_COMMON_INCLUDES_ */

#include "AdaptivePacing_3_types.h"
...
typedef struct {
  ...
  real_T Avg;                          /* '<S1>/Chart' */
  uint32_T is_c3_AdaptivePacing_3;     /* '<S1>/Chart' */
  uint32_T temporalCounter_i1;         /* '<S1>/Chart' */
  uint8_T is_active_c3_AdaptivePacing_3;/* '<S1>/Chart' */
} DW_AdaptivePacing_3_T;

/* Parameters (default storage) */
struct P_AdaptivePacing_3_T_ {
...
struct tag_RTM_AdaptivePacing_3_T {
...
extern P_AdaptivePacing_3_T AdaptivePacing_3_P;

/* Block signals (default storage) */
extern B_AdaptivePacing_3_T AdaptivePacing_3_B;

/* Block states (default storage) */
extern DW_AdaptivePacing_3_T AdaptivePacing_3_DW;

/* Model entry point functions */
extern void AdaptivePacing_3_initialize(void);
extern void AdaptivePacing_3_step(void);
extern void AdaptivePacing_3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_AdaptivePacing_3_T *const AdaptivePacing_3_M;
 ...
 *
 * '<Root>' : 'AdaptivePacing_3'
 * '<S1>'   : 'AdaptivePacing_3/Adaptive Pacing'
 * '<S2>'   : 'AdaptivePacing_3/Adaptive Pacing/Chart'
 */
#endif                                 /* RTW_HEADER_AdaptivePacing_3_h_ */
