###########################################################################
## Makefile generated for Simulink model 'AdaptivePacing_1'. 
## 
## Makefile     : AdaptivePacing_1.mk
## Generated on : Thu Dec 03 10:48:20 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/AdaptivePacing_1.elf
...
COMPILER_COMMAND_FILE     = AdaptivePacing_1_comp.rsp
CMD_FILE                  = AdaptivePacing_1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/AdaptivePacing_1.elf
...
DEFINES_STANDARD = -DMODEL=AdaptivePacing_1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = i2c_api.o MW_I2C.o mw_sdk_interface.o AdaptivePacing_1.o AdaptivePacing_1_data.o AdaptivePacing_1_tgtconn.o rtGetInf.o rtGetNaN.o rt_nonfinite.o updown.o ext_work.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o k64f_rtiostream_interface.o k64f_rtiostream_commservice.o k64f_ext_svr.o k64f_rtiostream_utils.o tgtSvc_UARTInfo.o
...
%.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AdaptivePacing_1.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/AdaptivePacing_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AdaptivePacing_1_data.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/AdaptivePacing_1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


AdaptivePacing_1_tgtconn.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/AdaptivePacing_1_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/AdaptivePacing_1_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
