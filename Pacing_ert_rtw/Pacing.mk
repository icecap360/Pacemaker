###########################################################################
## Makefile generated for Simulink model 'Pacing'. 
## 
## Makefile     : Pacing.mk
## Generated on : Sat Oct 24 22:39:31 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Pacing.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/iceca/Documents/Pacemaker
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Pacing_comp.rsp
CMD_FILE                  = Pacing.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Pacing.elf
...
DEFINES_STANDARD = -DMODEL=Pacing -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o mw_sdk_interface.o MW_digitalIO.o Pacing.o Pacing_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Pacing_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pacing_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Pacing_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pacing_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Pacing_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Pacing_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pacing.o : $(START_DIR)/Pacing_ert_rtw/Pacing.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pacing_data.o : $(START_DIR)/Pacing_ert_rtw/Pacing_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
